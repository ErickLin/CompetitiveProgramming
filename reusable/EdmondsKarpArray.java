...
public class EdmondsKarpArray {
    /**
     * Maximum flow algorithm (O(V * E^2))
     * @param c an adjacency list of dictionaries that map neighboring nodes to capacities
     * @param s the source
     * @param t the sink
     * @return the maximum flow f
     */
    public static int edmondsKarp(ArrayList<HashMap<Integer, Integer>> c, int s, int t) {
        if (s == t)
            return 0;
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        g.get(7).put(9, 7);
        g.get(8).put(9, 10);
        System.out.println(edmondsKarp(g, 0, 9));
    }
}